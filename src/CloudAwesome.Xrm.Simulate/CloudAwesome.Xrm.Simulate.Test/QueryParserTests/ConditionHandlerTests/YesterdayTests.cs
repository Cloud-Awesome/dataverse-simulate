...
public class YesterdayTests
{
    ...
    {
        var handler = new YesterdayConditionHandler();
        handler.Operator.Should().Be(ConditionOperator.Yesterday);
    }
    ...
    { 
        Query = @"<fetch version=""1.0"" output-format=""xml-platform"" mapping=""logical"" distinct=""false"">
                  <entity name=""contact"">
                    ...
                    <filter type=""and"">
                      <condition attribute=""overriddencreatedon"" operator=""yesterday"" />
                    </filter>
                  </entity>
                </fetch>" 
    };
